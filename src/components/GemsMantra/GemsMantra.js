...
Recommendation</h2>
    ...
    <div className='grid md:grid-cols-3 mx-auto sm:max-w-5xl max-w-6xl '>
      ...
      <div className="rounded-md col-span-3 lg:col-span-2 mx-2 mt-6 w-auto sm:mt-6 bg-white p-6 px-8 sm:px-16 py-4 sm:py-14 shadow-2xl">

        <h1 className='text_color sm:text-3xl text-lg md:text-2xl py-6 sm:py-8 font-bold'>Please Fill Your Birth Details Here:</h1>
        ...
        <div className="mt-10">
          <button
            type="submit"
            className="block w-full rounded-md btn_color px-3.5 py-2.5 text-center text-sm  text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            onClick={() => findGems()}
          >
            Submit
          </button>
